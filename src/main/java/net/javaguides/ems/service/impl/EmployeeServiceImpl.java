...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto createEmployee(EmployeeDto employeeDto) {
        ...
        Department department=departmentRepository.findById(employeeDto.getDepartmentId()).orElseThrow(
                ()-> new ResourceNotFoundException("department not exist with given id :"+ employeeDto.getDepartmentId())
        );
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
        ...
        Department department=departmentRepository.findById(updatedEmployee.getDepartmentId()).orElseThrow(
                ()-> new ResourceNotFoundException("department not exist with given id :"+ updatedEmployee.getDepartmentId())
        );
        employee.setDepartment(department);
